    ...
    <>
      <section className="h-full flex flex-col md:flex-row items-center md:items-center">
        ...
        <div className="flex flex-col gap-25 w-full pl-8 md:pl-16">
          <div className="">
            <div className="text-5xl lg:text-9xl md:text-7xl sm:text-xl font-bold font-aeonik translate-x-[5vw] whitespace-nowrap">
              <Copy1 delay={0.2}>
                <h1>
                  Making Ideas
                </h1>
            ...
            <div className="text-5xl lg:text-9xl md:text-7xl sm:text-9xl font-bold font-aeonik md:translate-x-[5vw] translate-x-[4vw]">
              <Copy delay={0.3}>
                <h1>
                  Into Reality
                </h1>
          ...
          <div className="flex items-center justify-center translate-y-[-130px]">
            <div className="flex md:scale-120 items-center justify-center">
              <IconCloud
                icons={[
        ...
        {/* Right: Content + CTA */}
        <div className="flex flex-col gap-10 md:w-1/2 md:translate-x-[-50px] md:translate-y-[80px] translate-y-[-120px] justify-center items-center">
          <div className="translate-y-[-50px]">
            <CopyLines>
              <h4 className="text-[#1a1a1a] font-aeonik font-bold w-[85vw] md:w-[85%] text-justify lg:text-md translate-y-[-50px]">
            ...
            <div className="translate-y-[-85px] md:translate-y-[-55px]">
              <CTAButton />
            </div>
        </div>
